...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?= base_url('assets/pannelAssets/')?>dist/css/adminlte.min.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?= base_url('Admin');?>"><img src="<?= base_url('assets/pannelAssets/icons/');?>logo.png" ></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
...
<!-- jQuery -->
<script src="<?= base_url('assets/pannelAssets/')?>plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap 4 -->
<script src="<?= base_url('assets/pannelAssets/')?>plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- AdminLTE App -->
<script src="<?= base_url('assets/pannelAssets/')?>dist/js/adminlte.min.js"></script>
